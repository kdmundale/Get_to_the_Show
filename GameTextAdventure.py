    ...
    def play(self):
        print(dedent("""
                     **************************************************************************************
                     ...
                     Messing with girls like Katia will have yu waking up in a tub of ice with a kidney missing.
...
class Contents(object):
    ...
    chapters = {'wintickets': WinTickets(), 'bar': Bar(), 'havedrink': HaveDrink(), 'inline': InLine(), 'concert': Concert()}
